...
export default function Success({customerName, product}:SuccessProps) {
    return (
        ...
        <IMGContainer><Image src={product.imageUrl} alt={""} width={120} height={110}/></IMGContainer>
        <p>
            Uhuuuuu <strong>{customerName}</strong>, sua <strong>{product.name} </strong> esta acaminho de casa!
        </p>
